...
start cmd.exe /K "cd %baseDir%\IdSvrHost\ && dotnet watch run" 
start cmd.exe /K "cd %baseDir%\WebApi\ && dotnet watch run" 
start cmd.exe /K "cd %baseDir%\AureliaAspNetApp\ && dotnet watch run" 
