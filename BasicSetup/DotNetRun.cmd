...
start cmd.exe /K "cd %baseDir%\IdSvrHost\ && dotnet watch" 
start cmd.exe /K "cd %baseDir%\WebApi\ && dotnet watch" 
start cmd.exe /K "cd %baseDir%\AureliaAspNetApp\ && dotnet watch" 
