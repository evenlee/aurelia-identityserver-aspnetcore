...
/***/ function(module, exports, __webpack_require__) {
	...
	var _authConfig = __webpack_require__(76);
	...
	(0, _aureliaBootstrapperWebpack.bootstrap)(function (aurelia) {
	    ...
	    aurelia.use.standardConfiguration().developmentLogging().plugin('aurelia-authentication', function (baseConfig) {
	        //the name of plugin becomes 'paulvanbladel/aurelia-auth'
